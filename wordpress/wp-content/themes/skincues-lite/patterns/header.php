...
/**
 * Title: Header
 * Slug: skincues-lite/header
 * Categories: skincues-lite, header
 */
?>

<!-- wp:group {"align":"full","className":"header header-block-header","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull header wp-block-header">
	...
	<div class="wp-block-group alignfull wp-block-main-header">
		...
		<div class="wp-block-group alignfull" style="padding-top:var(--wp--custom--spacing--tiny);padding-bottom:var(--wp--custom--spacing--tiny)">
			...
			<!-- wp:navigation {"className":"main-navigation","icon":"menu","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"start"}} /-->
			...
			<div class="wp-block-group wp-block-search-user-cart">
				...
				<div class="wp-block-group wp-custom-product-search"><!-- wp:group {"className":"wp-search-toggle","layout":{"type":"constrained"}} -->
					<div class="wp-block-group wp-search-toggle"><!-- wp:image {"sizeSlug":"full","linkDestination":"custom","className":"icon-search"} -->
						<figure class="wp-block-image size-full icon-search"><a href="#"><img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/search-dark.png')); ?>" alt="" /></a></figure>
						<!-- /wp:image -->

						<!-- wp:image {"sizeSlug":"full","linkDestination":"custom","className":"icon-close"} -->
						<figure class="wp-block-image size-full icon-close"><a href="#"><img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/close-dark.png')); ?>" alt="" /></a></figure>
						<!-- /wp:image -->
					</div>
					<!-- /wp:group -->
